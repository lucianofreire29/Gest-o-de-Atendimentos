...
from utils.funcoes import titulo, entry_cadastro, validar_data_entry, validar_telefone, cadastrar_paciente, limpar_campos, criar_datepicker
...
class CadastrarPaciente(ctk.CTkFrame):
        ...
        # titulo 
                self.label_titulo = ctk.CTkLabel(self.container,text="Cadastro de Pacientes",text_color=AZUL_FONTE_TEXTO,font=("",16))
                self.label_titulo.pack(pady=10,anchor="center")

                frame_nome = ctk.CTkFrame(self.container, fg_color="transparent")
                ...
                frame_linha = ctk.CTkFrame(self.container, fg_color="transparent")
                ...
                frame_contato = ctk.CTkFrame(self.container, fg_color="transparent")
